...
// Sun Dec  8 15:30:46 2019 by ROOT version 6.14/09
// from TTree PhotonAnalyzer_Tree/Event data
// found on file: PhotonAnalyzer_DY2021MC_withgenmatching.root
//////////////////////////////////////////////////////////

#ifndef tree_analyser_h
#define tree_analyser_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   tree_analyser(TTree *tree=0);
   virtual ~tree_analyser();
...
#ifdef tree_analyser_cxx
tree_analyser::tree_analyser(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("PhotonAnalyzer_DY2018MC_withgenmatching.root");
     //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("PhotonAnalyzer_QCD2021MC_withgenmatching.root");
     //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("PhotonAnalyzer_TTToSemileptonic2021MC_withgenmatching.root");
      if (!f || !f->IsOpen()) {
	f = new TFile("PhotonAnalyzer_DY2018MC_withgenmatching.root");
	//f = new TFile("PhotonAnalyzer_QCD2021MC_withgenmatching.root");
	//f = new TFile("PhotonAnalyzer_TTToSemileptonic2021MC_withgenmatching.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("PhotonAnalyzer_DY2018MC_withgenmatching.root:/photonanalyzer");
      //TDirectory * dir = (TDirectory*)f->Get("PhotonAnalyzer_QCD2021MC_withgenmatching.root:/photonanalyzer");
      //TDirectory * dir = (TDirectory*)f->Get("PhotonAnalyzer_TTToSemileptonic2021MC_withgenmatching.root:/photonanalyzer");
...
tree_analyser::~tree_analyser()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tree_analyser::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tree_analyser::LoadTree(Long64_t entry)
{
...
void tree_analyser::Init(TTree *tree)
{
...
void tree_analyser::Show(Long64_t entry)
{
...
Int_t tree_analyser::Cut(Long64_t entry)
{
